...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            nan_replacement_step = ("na_replacement" , FunctionTransformer(replace_na_with_nan))
            impute_step = ("impute" , SimpleImputer(strategy='constant' , fill_value=0))
            ...
            logging.info("Exception occured in get_data_transformer_object")
